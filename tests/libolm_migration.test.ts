...
describe("Migration", () => {
    test("It should correctly import data", async () => {
        ...
        testData.crossSigningMasterKey = "oob99xn8lk3eXXERE9U/Zj6gFIsrmAgq3KGvE5Wr0r4=";
        testData.crossSigningSelfSigningKey = "YH1IjbOdpOrIgYZRnQuTInLDV6iSzZ1bNs/UKvUOAII=";
        testData.crossSigningUserSigningKey = "3SFl1AdH3egRKnP5OJZt9wJyamK/SEi8Pfw3dd0mPMo=";
